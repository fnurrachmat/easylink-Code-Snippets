...
func main() {
	...
	fmt.Println("Fetching Account Balances...")
	_, res, err := SendEasylinkRequest(baseURL, "/finance-account/balances", "POST", map[string]interface{}{}, appKey, privateKeyPem, accessToken)
	if err != nil {
		fmt.Printf("Error: %v\n", err)
	} else {
