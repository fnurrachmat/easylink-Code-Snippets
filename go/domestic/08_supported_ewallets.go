...
func main() {
	...
	fmt.Println("Fetching Supported E-Wallet Codes...")
	_, res, err := SendEasylinkRequest(baseURL, "/v2/data/supported-inst-code", "POST", map[string]interface{}{}, appKey, privateKeyPem, accessToken)
	if err != nil {
		fmt.Printf("Error: %v\n", err)
	} else {
