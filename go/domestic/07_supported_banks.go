...
func main() {
	...
	fmt.Println("Fetching Supported Bank Codes...")
	_, res, err := SendEasylinkRequest(baseURL, "/v2/data/supported-bank-code", "POST", map[string]interface{}{}, appKey, privateKeyPem, accessToken)
	if err != nil {
		fmt.Printf("Error: %v\n", err)
	} else {
