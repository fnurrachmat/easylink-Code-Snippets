...
func main() {
	...
	fmt.Println("Fetching International Transfer Status...")
	_, res, err := SendEasylinkRequest(baseURL, "/transfer/get-international-transfer", "POST", payload, appKey, privateKeyPem, accessToken)
	if err != nil {
		fmt.Printf("Error: %v\n", err)
	} else {
