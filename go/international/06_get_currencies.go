...
func main() {
	...
	fmt.Println("Fetching List of Currencies...")
	_, res, err := SendEasylinkRequest(baseURL, "/data/list-currencies", "POST", map[string]interface{}{}, appKey, privateKeyPem, accessToken)
	if err != nil {
		fmt.Printf("Error: %v\n", err)
	} else {
